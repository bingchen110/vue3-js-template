...
const action = import.meta.env.VITE_API + '/upload'
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>文章管理</span>
                <div class="extra">
                    <el-button type="primary" @click="addShow">添加文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
        ...
        <el-table :data="articles" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
                <template #default="{ row }">
                    <el-button :icon="Edit" circle plain type="primary" @click="editShow(row)"></el-button>
        ...
        <el-drawer v-model="visibleDrawer" title="添加文章" direction="rtl" size="50%">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章封面">
                    ...
                    <el-upload class="avatar-uploader" :auto-upload="true" :show-file-list="false" name="file"
                        :action="action" :headers="{ 'Authorization': tokenStore.token }" :on-success="uploadSuccess">
